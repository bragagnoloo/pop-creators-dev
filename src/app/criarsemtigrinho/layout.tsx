...
export const metadata: Metadata = {
  ...
  description:
    'É possível viver da internet sem divulgar apostas. O #CriarSemTigrinho reúne oportunidades reais de monetização para creators — campanhas com marcas, UGC, afiliados, plataformas e editais. Crie mais. Monetize melhor.',
