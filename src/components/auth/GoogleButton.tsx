...
export default function GoogleButton({ onError }: GoogleButtonProps) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 disabled:opacity-60 disabled:cursor-not-allowed text-gray-900 font-medium py-3 px-4 rounded-xl transition-colors"
    >
      <GoogleIcon />
